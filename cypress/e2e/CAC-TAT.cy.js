...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
      ...
      it('verifica se o campo telefone aceita apenas caracter numérico', function() {
        cy.get('#phone').type("abc5191abc").should('have.value', '5191')
      })
